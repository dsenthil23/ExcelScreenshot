...
public class ScreenshotUtilApache{
    ...
    public static String excelSSApache(String excelPath, String imagePath) throws Exception {
        String base64Image;
        try (FileInputStream fis = new FileInputStream(excelPath);
            ...
            int maxCellWidth = 0;
            int maxCellHeight = metrics.getHeight() + 10;
            ...
            // Write image to ByteArrayOutputStream and encode as Base64
